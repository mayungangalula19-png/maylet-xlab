-- Investment Operations: deal pipeline for admin investor command center
...
CREATE INDEX IF NOT EXISTS idx_investor_deals_expected_close ON public.investor_deals(expected_close_date);
