-- Career opportunities — admin-managed jobs, internships, fellowships, etc.
...
CREATE INDEX IF NOT EXISTS idx_career_opportunities_published ON public.career_opportunities(published_at DESC)
