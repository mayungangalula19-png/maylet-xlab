...
class _VaultListScreenState extends State<VaultListScreen> {
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () => context.push('/dashboard/vault/create').then((_) => _loadEntries()),
                    ...
                    Row(
                      children: [
                        ...
                        FilterChip(
                          ...
                          selectedColor: const Color(0xFF2fd4ff).withOpacity(0.2),
  ...
  Widget _vaultCard(VaultEntry entry) {
    return Card(
      ...
      elevation: 0,
      child: InkWell(
        onTap: () => context.push('/dashboard/vault/${entry.id}').then((_) => _loadEntries()),
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: entry.isPublic ? const Color(0xFF2fd4ff).withOpacity(0.2) : Colors.white.withOpacity(0.1),
                      borderRadius: BorderRadius.circular(20),
                    ),
                    child: Text(
              ...
              if (entry.tags.isNotEmpty)
                Wrap(
                  ...
                  children: entry.tags.take(3).map((tag) => Container(
                    padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 3),
                    decoration: BoxDecoration(
                      color: const Color(0xFF7c5fe6).withOpacity(0.3),
                      borderRadius: BorderRadius.circular(20),
                    ),
