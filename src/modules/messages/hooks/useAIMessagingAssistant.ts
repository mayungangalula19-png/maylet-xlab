...
export function useAIMessagingAssistant(
  ...
  const runAnalysis = useCallback(
    async (convId: string, list: Message[]) => {
      ...
      try {
        ...
        const payload = messagesAIService.analyze(convId, list);
        ...
        void messagesAIService.persistMemory(mergedMemory);
        messagesAIMemoryService.buildContext(mergedMemory, list);
