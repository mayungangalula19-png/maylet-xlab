// C:\Users\user\maylet-xlab\src\app\routes\VaultEntry.tsx
// PROFESSIONAL VAULT ENTRY DETAIL – View, edit, delete single vault entry
  ...
  if (loading) {
    return (
      <div className="vault-entry-container">
        <main className="entry-main"><div className="loading-spinner"></div></main>
      </div>
    );
  }
  ...
  return (
    <div className="vault-entry-container">
      ...
      <style>{`
        ...
        .entry-description h3, .entry-details h3 {
