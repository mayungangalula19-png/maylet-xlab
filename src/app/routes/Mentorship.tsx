...
// ============================================================
// SIDEBAR (reused from other pages)
// ============================================================
const Sidebar = () => {
  ...
  const mainMenu = [
    ...
    { icon: '🎓', label: 'Mentorship', route: '/mentorship', active: true },
...
const MentorCard = ({ mentor, onRequest }: { mentor: Mentor; onRequest: (mentor: Mentor) => void }) => (
  <div className="mentor-card">
    <div className="mentor-avatar">
      {mentor.avatar_url ? <img src={mentor.avatar_url} alt={mentor.full_name} /> : <span>{mentor.full_name.charAt(0)}</span>}
    </div>
